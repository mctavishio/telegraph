const fs = require("fs"); 
const indextitle = "telegraph";
const tools = require("./tools.js");
const mills = require("./indexFiles.js").reverse();
const dt = new Date();
const timestamp = dt.getTime();
const datetime = dt.toDateString();
const description = "code art ::: algorithmic telegraph";
...
<article id="videoall">
	...
	<div class="vimeowrapper16x9" >
		<iframe src="https://player.vimeo.com/video/946014864?title=0&amp;byline=0&amp;portrait=0" width="600" height="338"frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
	</div>
	</figure>
	</div>
</article>
...
indexhtml = indexhtml + mills.map( name=>name.slice(4) ).map( name=>{
	return	`
		<li><a href="index${name}.html">${indextitle} sequence ${name}</a></li>`;
}).join("");
indexhtml = indexhtml + ` 
	</ul>
	</div>
...
<main class="expand wide" id="top">`;
	html = html + `
<header>
	<h1>${indextitle} sequence</h1>
	<h2>created ::: ${mill.datetime}</h2>
</header>
<nav>
	<ul>
		<li><a href="index.html" id="indexlink">back to ${indextitle} index</a></li>
		<li><a href="https://mctavish.work/index.html" id="homelink">go to mctavish portfolio</a></li>
